...
class Mamba_TimeVariant(nn.Module):
    def __init__(
        ...
        conv_bias=True,
        bias=False,
        use_fast_path=False,  # Fused kernel options. Fixed to False for now.
        layer_idx=None,
        device=None,
        dtype=None,
        timevariant_dt=True,
        ...
        ) if sum(self.output_dim) > 0 else None
    ...
    def forward(self, hidden_states, inference_params=None):
        ...
        if self.use_fast_path and causal_conv1d_fn is not None and inference_params is None:  # Doesn't support outputting the states
            ...
            if not self.tv_dt:
                ...
                dt = dt.view(1, -1, 1).expand(batch, self.d_inner, seqlen)  # (batch, d_inner, seqlen)
            else:
